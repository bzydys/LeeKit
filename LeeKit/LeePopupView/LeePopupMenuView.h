 ...
 */
@interface LeePopupMenuView : LeePopupContainerView
...
@property(nonatomic, copy) NSArray<LeePopupMenuItem *> *items;
@property(nonatomic, copy) NSArray<NSArray<LeePopupMenuItem *> *> *itemSections;

@end

/**
 *  配合 LeePopupMenuView 使用，用于表示一项菜单项。
 *  支持显示图片和标题，以及点击事件的回调。
 *  可在 LeePopupMenuView 里统一修改菜单项的样式，如果某个菜单项需要特殊调整，可获取到对应的 LeePopupMenuItem.button 并进行调整。
 */
@interface LeePopupMenuItem : NSObject
