...
/**
 * `LeeToastView`默认使用的contentView。其结构是：customView->textLabel->detailTextLabel等三个view依次往下排列。其中customView可以赋值任意的UIView或者自定义的view。
 *
 * @TODO: 增加多种类型的progressView的支持。
 */

@interface LeeToastContentView : UIView
